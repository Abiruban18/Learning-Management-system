...
export async function sendDeadlineReminder(to: string, name: string, courseTitle: string, moduleTitle: string, deadline: Date) {
...
export async function sendNewCourseEmail(to: string, name: string, courseTitle: string, courseId: string) {
  await transporter.sendMail({
    from,
    to,
